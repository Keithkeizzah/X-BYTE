...
if (config.COMMAND_TYPE === "button") {
  ...
  cmd(_0x1c4a95, async (_0x1eb185, _0x2ca636, _0x1c62c7, {
    ...
    try {
      ...
      const _0x49e75b = "*X - B Y T E* \n\n < S O N G -- D O W N L O A D E R <\n\n> *`O: Title` :* " + _0x5bff47.title + "\n\n> *`O: Size` :* " + _0x5bff47.size + "\n\n> *`O: Duration` :* " + _0x5bff47.timestamps + "\n\n> *`O: Quality` :* " + _0x4b358e.quality + "\t\t\t\t   \n\n> *`O: URL` :* " + _0x5bff47.url + "\n";
      let _0x38413d = [{
        'name': "quick_reply",
  ...
  cmd(_0xc77745, async (_0x3fe280, _0xb7519, _0x13111a, {
    ...
    try {
      ...
      const _0x2f21f6 = "*X - B Y T E* \n\n < V I D E O -- D O W N L D E R >\n    \n> *`O: Title` :* " + _0x13e748.title + "\n    \n> *`O: Views` :* " + _0x13e748.views + "\n    \n> *`O: Duration` :* " + _0x13e748.duration + "\n    \n> *`O: URL` :* " + _0x13e748.url + "\n    ";
      const _0x2cd4ce = [];
