...
if (!fs.existsSync(path.join(sessionDir, "creds.json"))) {
  if (config.SESSION_ID) {
    try {
      const decodedSessionId = Buffer.from(config.SESSION_ID.replace("keith;;;", ''), "base64").toString('utf-8');
    ...
    if (_0x53c492 === "close") {
      ...
      if (_0x53c492 === "open") {
        ...
        await _0x29dc59.sendMessage(config.OWNER_NUMBER + "@s.whatsapp.net", {
          'text': "*𝗛𝗨𝗡𝗖𝗛𝗢 𝗠𝗗 𝗜𝗦 𝗢𝗡𝗟𝗜𝗡𝗘*",
          'contextInfo': {
            'externalAdReply': {
              'title': "𝗣𝗼𝘄𝗲𝗿𝗲𝗱 𝗯𝘆 𝗞𝗲𝗶𝘁𝗵𝗸𝗲𝗶𝘇𝘇𝗮𝗵.",
        ...
        if (_0x1192eb.status == "offer") {
          if (_0x1192eb.isGroup == false) {
            await _0x29dc59.sendMessage(_0x1192eb.from, {
              'text': "⚠️︱I'm HUNCHO-MD, I reject this Call Because my owner is Busy!",
      ...
      try {
        ...
        for (let _0x47973d of _0x5daabc) {
          ...
          if (_0x4f1469.action == "add") {
            const _0x4d18a0 = moment.tz("Africa/Nairobi").format("HH:mm:ss");
            const _0x54d49a = moment.tz("Africa/Nairobi").format("DD/MM/YYYY");
            ...
            if (_0x4f1469.action == "remove") {
              const _0x12600d = moment.tz('Africa/Nairobi').format('HH:mm:ss');
              const _0x43a74e = moment.tz("Africa/Nairobi").format('DD/MM/YYYY');
      ...
      _0x29dc59.replyad = async _0x2d47ff => {
        return await _0x29dc59.sendMessage(_0x416738, {
          ...
          'contextInfo': {
            ...
            'externalAdReply': {
              'title': "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝗛𝗨𝗡𝗖𝗛𝗢",
              'body': "𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗯𝘆 𝗞𝗲𝗶𝘁𝗵𝗸𝗲𝗶𝘇𝘇𝗮𝗵",
              'mediaType': 0x1,
              'sourceUrl': "https://wa.me/254748387615",
              'thumbnailUrl': "https://i.imgur.com/4pWgAng.jpeg",
